...
type OrderStatus = "pending" | "processing" | "out_for_delivery" | "completed" | "cancelled";
type FilterType = "all" | "pending" | "processing" | "out_for_delivery" | "completed" | "cancelled";
...
const CashierOrderList: FC<StaffOrderListProps> = ({ onView, onProcess }) => {
                                    ...
                                    <TableRow className="hover:bg-gray-50" key={index}>
                                        ...
                                        <TableCell className="px-4 py-3 text-center">
                                            <span className="px-2 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-600">
                                                {order.order_type === "delivery" ? "Delivery" : "Walk-in"}
                                            </span>
                                        </TableCell>
                                        <TableCell className="px-4 py-3 text-center">
