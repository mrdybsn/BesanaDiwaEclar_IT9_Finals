...
const AddRecurringOrderModal: FC<AddRecurringOrderModalProps> = ({ isOpen, onClose }) => {
    const customers = [
        { customer_id: "", customer: "Select Customer" },
        { customer_id: "1", customer: "Dela Cruz, Juan M." },
        { customer_id: "2", customer: "Santos, Maria L." },
        { customer_id: "3", customer: "Reyes, Carlo B." },
        { customer_id: "4", customer: "Garcia, Ana P." },
    ];
            ...
            <form className="bg-white p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4 border-b border-gray-100 mb-4">
                    <div className="col-span-2 md:col-span-1">
                        <div className="mb-4">
                            <FloatingLabelSelect label="Customer" name="customer_id" required autoFocus>
                                {customers.map((c, index) => (
                                    <option value={c.customer_id} key={index}>{c.customer}</option>
                                ))}
                            </FloatingLabelSelect>
                        </div>
                        <div className="mb-4">
