...
import type { CustomerFieldErrors } from "../../../interfaces/CustomerInterfaces";
...
const AddCustomerFormModal: FC<Props> = ({ isOpen, onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setErrors({});
        try {
            await CustomerService.storeCustomer(form);
            onSuccess();
            setForm({
                first_name: "", middle_name: "", last_name: "", suffix_name: "",
                gender: "", birth_date: "", contact_number: "", address: "",
            ...
            <form onSubmit={handleSubmit} className="bg-white p-4 rounded-lg w-full max-w-2xl">
                ...
                <div className="grid grid-cols-2 gap-4 border-b border-gray-100 pb-4 mb-4">
                    ...
                    <div className="col-span-2 md:col-span-1 space-y-4">
                        ...
                        <FloatingLabelSelect label="Gender" required {...field("gender")}>
                            {GENDERS.map((g) => (
                    ...
                    <div className="col-span-2 md:col-span-1 space-y-4">
                        ...
                        <FloatingLabelInput label="Password"        type="password" {...field("password")} />
                ...
                <div className="flex justify-end gap-2">
                    ...
                    <SubmitButton label={loading ? "Saving…" : "Save Customer"} disabled={loading} />
                </div>
            </form>
        </Modal>
    );
